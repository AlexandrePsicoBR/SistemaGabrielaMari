...
const AnamneseCorporal: React.FC<AnamneseCorporalProps> = ({ patientData, onPrint, patientId }) => {
    ...
    const handleSave = () => {
        if (patientId) {
            localStorage.setItem(`anamnese_corporal_${patientId}`, JSON.stringify(formData));
            alert('Anamnese Corporal salva com sucesso!');
        }
    };
